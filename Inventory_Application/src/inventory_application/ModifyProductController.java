...
public class ModifyProductController {
    private ObservableList<Part> oldAssociatedParts;
    ObservableList<Part> tempAssociatedParts;
    @FXML
    ...
    public void initialize() {
        ...
        oldAssociatedParts = Inventory.getInstance().getProduct().getAllAssociatedParts();
        tempAssociatedParts = FXCollections.observableArrayList(oldAssociatedParts);
        associatedPartsTableView.setItems(tempAssociatedParts);
        associatedPartsTableView.getSelectionModel().selectFirst();

        Product tempPart = Inventory.getInstance().getProduct();
    ...
    public Product processProduct(){
        ...
        Product item = new Product(id,name,price,stock,min,max,"Product",tempAssociatedParts);

            Inventory.getInstance().updateProduct(Inventory.getInstance().getProduct().getId(),item);
